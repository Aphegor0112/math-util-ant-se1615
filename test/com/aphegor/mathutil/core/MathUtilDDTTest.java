...
import static com.aphegor.mathutil.core.MathUtil.getFactorial;
import org.junit.Test;
import static org.junit.Assert.*;
import org.junit.runner.RunWith;
import org.junit.runners.Parameterized;
//import static ... tên-class.tênhàm; thì sau này khi gọi hàm static bỏ luôn tên class chấm
//hiểu ngầm tên class code gọi như hàm của C
//.* là đại diện cho tất cả các hàm static trong class vừa import
//nếu rảnh thì . từng tên hàm static (ko có dấu ngoặc)

/**
 *
 * @author asus
 */
//KĨ THUẬT DDT - DRIVEN DATA TESTING
...
//Nếu ta muốn check hàm getF() với các giá trị đàu vào và có trả về đầu ra mong đợi hay ko, kiểu như
//0 -> 1
//1 -> 1
//2 -> 2
//3 -> 6
...
//lát hồi ta nhồi cáci đám data này vào hàm assertEquals(? getF(?))
//cảm giác viết code để test hàm nhìn rõ ràng hơn
//kĩ thuật để data test ra chỗ khác, lát hồi nhồi ngược lại vào
//chỗ gọi hàm, kĩ thuật này được gọi là DDT - viết test case theo kiểu
...
public class MathUtilDDTTest {
    ...
    //sau đó ta nhồi 2 biến này vào trong hmà assertEquals() như cũ
...
//TÍCH HỢP LIÊN TỤC - COUNTINUOUS INTEGRATION
